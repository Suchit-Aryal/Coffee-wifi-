...
class CafeForm(FlaskForm):
    ...
    opening_time=StringField('Open Time',validators=[DataRequired(),time_format])
    closing_time=StringField('Close Time',validators=[DataRequired(),time_format])
